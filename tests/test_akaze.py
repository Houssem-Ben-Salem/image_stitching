...
from methods.traditional.akaze import AKAZEStitching, default_config
from utils.data_loader import HPatchesDataset

class TestAKAZEStitching(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        """Set up test fixtures that can be reused across all tests."""
        cls.method = AKAZEStitching(default_config)
    ...
    def test_feature_detection(self):
        ...
        print(f"Number of AKAZE matches found: {len(matches)}")
