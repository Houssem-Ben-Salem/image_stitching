...
from methods.traditional.orb import ORBStitching, default_config
from utils.data_loader import HPatchesDataset

class TestORBStitching(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        """Set up test fixtures that can be reused across all tests."""
        cls.method = ORBStitching(default_config)
    ...
    def test_feature_detection(self):
        ...
        print(f"Number of ORB matches found: {len(matches)}")
